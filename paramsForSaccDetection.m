...
if nargin<3
% getting "gaze" from somewhere - insert path
load('')
gaze=[gazeX ; gazeY];
end
...
sacc_parameters.saccade_min_amp = 0.3; %  deg (minimal amplitude in degrees)
sacc_parameters.saccade_max_amp = 30; %  deg (maximal amplitude in degrees)
sacc_parameters.saccade_min_velocity = 8; %  deg/sec
% sacc_parameters.averagevelocity = 6; % (not in use)
sacc_parameters.saccade_peak_velocity = 16; %  deg/sec
